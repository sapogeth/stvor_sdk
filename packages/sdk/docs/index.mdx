...
- [Installation](#installation) — 30 seconds to start
- [Quickstart](#quickstart) — Working example
- [API Reference](#api-reference) — Full API docs
- [Security Model](#security-model) — What we protect
- [Limitations](#limitations--deployment) — What we don't
...
✅ **Replay protection** — Within documented operational limits (requires persistent storage for full guarantees)  
...
*STVOR SDK v2.1 — Honest cryptography, no marketing claims. (Feb 2026)*
