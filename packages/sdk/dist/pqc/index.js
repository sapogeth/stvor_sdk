...
import { mlkemKeyGen, mlkemEncaps, mlkemDecaps, EK_SIZE, DK_SIZE, CT_SIZE, SS_SIZE, } from './mlkem.js';
 ...
 */
export function pqcDecaps(ct, dk) {
 ...
 */
export function hybridKDF(classicalSS, pqcSS, context = 'stvor-hybrid-v1') {
...
export function pqcEkToBase64(ek) {
    return Buffer.from(ek).toString('base64url');
}
export function pqcEkFromBase64(s) {
    return new Uint8Array(Buffer.from(s, 'base64url'));
}
export function pqcCtToBase64(ct) {
    return Buffer.from(ct).toString('base64url');
}
export function pqcCtFromBase64(s) {
    return new Uint8Array(Buffer.from(s, 'base64url'));
}
